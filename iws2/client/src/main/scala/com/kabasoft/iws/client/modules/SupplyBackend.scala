...
import com.kabasoft.iws.client.components.LineFDocumentList
...
class SupplyBackend($: BackendScope[Props[FDocument[LineFDocument], LineFDocument, Store, Supplier], State[FDocument[LineFDocument]]]) extends
  ...
  override def  buildForm (p: Props[FDocument[LineFDocument], LineFDocument, Store, Supplier], s:State[FDocument[LineFDocument]],
