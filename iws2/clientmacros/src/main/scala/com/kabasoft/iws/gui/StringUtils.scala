...
object StringUtils {
  ...
  val LineFin_Trans_Headers = Seq ("Id", "AccNo", "D/C", "OAccNo", "Amount", "Duedate",  "Text")
  val LineFin_Trans_Headers_old = Seq ("Id", "Account", "Debit/Credit", "OAccount", "Amount", "Duedate",  "Text")
